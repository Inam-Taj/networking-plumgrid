...
class TestPhysicalAttachmentPoint(base.BaseNetworkTest):
    ...
    def test_create_pap(self):
        ...
        # create Pap
        new_pap = rest_c.create_pap(name=temp_pap_name, interfaces=interfaces,
        ...
        rest_c.delete_pap(new_pap['physical_attachment_point']['id'])
    ...
    def test_show_pap(self):
        ...
        # show PAP
        temp_pap = rest_c.show_pap(new_pap['physical_attachment_point']['id'])
    ...
    def test_update_pap(self):
        ...
        new_pap = rest_c.create_pap(name=new_pap_name,
                                    interfaces=interfaces, hash_mode="L2",
                                    lacp="True")

        updated_pap = rest_c.update_pap(new_pap['physical_attachment_point']
    ...
    def test_delete_pap(self):
        ...
        result = rest_c.delete_pap(new_pap['physical_attachment_point']['id'])
    ...
    def test_create_pap_name(self):
        ...
        # create Pap
        new_pap = rest_c.create_pap(name=temp_pap_name)
    ...
    def test_create_pap_lacp(self):
        ...
        # create Pap
        new_pap = rest_c.create_pap(lacp=True)
    ...
    def test_create_pap_hash_mode(self):
        ...
        # create Pap
        new_pap = rest_c.create_pap(hash_mode="L2")
    ...
    def test_create_pap_interfaces_dict(self):
        ...
        # create Pap
        new_pap = rest_c.create_pap(interfaces=interfaces)
